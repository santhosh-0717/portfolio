...
interface WorkshopCertificateCardProps {
    companyName: string;
...
export default function WorkshopCertificateCard({
                                            companyName,
                                            recipientName,
                                            courseName,
                                            isworkshop,
            ...
            <CardContent className="flex flex-col items-center space-y-4 p-6">
                <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground mt-4">
                        has successfully completed the {isworkshop ? "workshop" : "internship"}
                    </p>
